...
define("pace","展開派 ペースメーカー","隊列とペースから、有利な位置を取れる馬を評価します。",["quinella","trio"],{paceFit:20,styleFit:20,leaders:15,drawStyle:10,courseStyle:10,dayBias:10,closing:5,earlySpeed:5,positionStability:5},{minimumEv:1.08,minimumConfidence:.55}),
define("analyst","数理派 アナリスト","推定勝率、誤差、オッズの3点から購入可否を判断します。",["win"],{calibratedWin:30,expectedValue:25,modelConfidence:15,sampleSize:10,calibrationQuality:10,oddsFreshness:5,lowVariance:5},{minimumEv:1.1,minimumConfidence:.7}),
define("contrarian","逆張り派 コントラリアン","評価集中が妥当か、オッズに妙味が残っているかを確認します。",["win","trio"],{consensus:20,overbet:20,marketGap:15,disagreement:15,favoriteRisk:10,alternativeValue:10,oddsMovement:5,modelDiversity:5},{minimumEv:1.15,minimumConfidence:.55,minimumWinProbability:.04})]);
