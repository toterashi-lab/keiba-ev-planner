...
const baseBootstrap = `<base id="site-base" href=""><script>if(location.hostname.endsWith("github.io"))document.querySelector("#site-base").href="keiba-ev-planner/";</script>`;
