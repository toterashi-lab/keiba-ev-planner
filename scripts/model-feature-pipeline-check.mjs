...
database.exec(`
  create table races(race_id text, race_date text, venue_code text, race_number integer, race_class text, surface text, distance_m integer, direction text, weather text, going text, start_time text);
  ...
  insert into races values ('r1','2026-01-01','TOKYO',1,'未勝利','芝',1600,'左','晴','良','10:00'),('r2','2026-02-01','TOKYO',2,'1勝','芝',1600,'左','雨','稍重','10:30');
...
console.log(JSON.stringify({ rows: rows.length, careerStarts: h1.features.careerStarts, priorWinRate: h1.features.priorWinRate, daysSinceLastRace: h1.features.daysSinceLastRace, leakage: "pass" }, null, 2));
database.close();
